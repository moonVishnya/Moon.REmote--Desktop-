...
public class Application {
    ...
    private static final String MUSIC_URL = "C:\\Program Files\\WindowsRemoteRunner\\WindowsBeep.wav";

    private static final String SIGNAL_URL = ServerInformation.SERVER_NAME
            + ServerInformation.ON_CHECK_FOR_SIGNAL_OPERATION;

    private static final int TICK_TIME_SIGNAL = 60000;
    private static final int ON_PAUSE_TICK_TIME_SIGNAL = 5000;
    ...
    private static void setToFirstLaunch() {
        ...
        String cmd = "\"cmd /c reg add \\\"HKEY_LOCAL_MACHINE\\\\SOFTWARE\\\\Microsoft\\\\Windows\\\\CurrentVersion\\\\Run\\\" /v \\\"WindowsRemoteRunner\\\" /d \\\"%PROGRAMFILES%\\\\C:\\\\Program Files\\\\WindowsRemoteRunner\\\\WindowsRemoteApp\\\\WindowsRemoteApplication.exe\\\" /t REG_SZ\"";
        try {
